...
public class LLMathHelper
{
	...
	*/
	...
	/**  
	  ...
	  * @return  
	  */
	public static String parse16(long num)
	{
	...
	public static int random(Integer[] rateArray)
	{
		...
		return LLMathHelper.random(rateArrayInt);
	}
	...
	public static int random(int[] rateArray)
	{
		...
		int randomInt=LLMathHelper.random(1,rateSum);
		int bingoIndex=-1;
		for(int i=0;i<arrayLength;i++)
		{
	...
	{
		if(shakeNum>=1) return true;
		if(shakeNum<=0) return false;
	...
	public static double matchlog(int a,double b){
		double d=Math.log10(a)/Math.log10(b);
		return d;
	}
}
